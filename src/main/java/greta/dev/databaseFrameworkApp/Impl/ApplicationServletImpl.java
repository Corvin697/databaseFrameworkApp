...
import greta.dev.databaseFrameworkApp.ApplicationServlet;
...
public class ApplicationServletImpl extends HttpServlet implements ApplicationServlet{
    MongoDb mongoDb;
    ...
    @Override
    public void writeSql(ResultSet resultSet, HttpServletResponse httpServletResponse) throws SQLException, IOException {
    ...
    @Override
    public void writeDocuments(Document[] documents, HttpServletResponse httpServletResponse) throws IOException {
